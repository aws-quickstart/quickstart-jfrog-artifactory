...
(`ArtifactoryVersion`)|`7.17.4`|Version of Artifactory that you want to deploy into the Quick Start. See the release notes to select the version you want to deploy at https://www.jfrog.com/confluence/display/RTF/Release+Notes.|Secondary instances
...
(`XrayVersion`)|`3.21.2`|The version of Xray that you want to deploy into the Quick Start.|Number of JFrog Xray instances
